...
//
import iD from './data/huawei_ids.json';
import telemetry from './data/huawei_telemetry.json';
import graphData from './data/huawei.json';
...
export default function HuaweiView() {
