...
//
import iD from './data/samsung_ids.json';
import telemetry from './data/samsung_telemetry.json';
import graphData from './data/samsung.json';
...
export default function SamsungView() {
